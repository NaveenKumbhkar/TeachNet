...
export default function VideoDetailsSidebar({ setReviewModal }) {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex h-[calc(100vh-3.5rem)] w-[320px] flex-col border-r border-richblack-700 bg-richblack-800">
        ...
        <div className="mx-5 flex flex-col gap-4 border-b border-richblack-600 py-5 text-richblack-25">
          ...
          <div className="flex justify-between">
            ...
            <button
              className="rounded-lg bg-richblack-200 px-3 py-1 text-richblack-900"
              onClick={() => setReviewModal(true)}
            >
              Add Review
            </button>
        ...
        <div className="overflow-y-auto">
          ...
          {courseSectionData.map((course, index) => (
            ...
            <div key={index} onClick={() => setActiveStatus(course._id)}>
              ...
              <div className="flex justify-between bg-richblack-600 px-5 py-4 text-white">
                {course.sectionName}
                <BsChevronDown />
              </div>
